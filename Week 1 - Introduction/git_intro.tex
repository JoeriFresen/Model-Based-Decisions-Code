...
\begin{frame}{What is Git?}
    ...
    \begin{center}
        \begin{tikzpicture}[node distance=2.5cm, >=Stealth]
            ...
            \draw[->, thick, blue!70] (repo) -- (local1) node[midway, left] {clone};
            \draw[->, thick, blue!70] (local1) -- (repo) node[midway, left] {push};
            \draw[->, thick, blue!70] (repo) -- (local2) node[midway, right] {clone};
            \draw[->, thick, blue!70] (local2) -- (repo) node[midway, right] {push};
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}{The Basic Git Workflow}
    \begin{center}
        \begin{tikzpicture}[node distance=2.3cm, every node/.style={align=center, rounded corners, minimum width=2.7cm, minimum height=1cm}]
